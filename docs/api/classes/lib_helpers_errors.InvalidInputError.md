[forex-demo](../README.md) / [Exports](../modules.md) / [lib/helpers/errors](../modules/lib_helpers_errors.md) / InvalidInputError
...
[src/lib/helpers/errors.ts:32](https://github.com/suphero/forex-demo/blob/ef493db/src/lib/helpers/errors.ts#L32)
